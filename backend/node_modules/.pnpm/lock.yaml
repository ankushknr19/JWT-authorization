...
dependencies:
  ...
  cookie-parser: 1.4.6
  express: 4.18.1
  express-rate-limit: 6.4.0_express@4.18.1
  helmet: 5.1.0
  joi: 17.6.0
  jsonwebtoken: 8.5.1
  lodash: 4.17.21
...
packages:
  ...
  /express-rate-limit/6.4.0_express@4.18.1:
    resolution: {integrity: sha512-lxQRZI4gi3qAWTf0/Uqsyugsz57h8bd7QyllXBgJvd6DJKokzW7C5DTaNvwzvAQzwHGFaItybfYGhC8gpu0V2A==}
    engines: {node: '>= 12.9.0'}
    peerDependencies:
      express: ^4 || ^5
    dependencies:
  ...
  /mongoose/6.4.4:
    resolution: {integrity: sha512-r6sp96veRNhNIWFtHHe4Lqak+ilgiExYnnMLhYTGdzjIMR90G1ayx0JKFVdHuC6dKNHGFX0ETJGbf36N8Romjg==}
    engines: {node: '>=12.0.0'}
    dependencies:
      bson: 4.6.5
      kareem: 2.4.1
